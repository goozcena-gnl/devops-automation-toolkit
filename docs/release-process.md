...
The release must remain a draft until the release-commit checks pass. Do not create or push the `v1.0.0` tag merely to populate a draft release; tag creation is the explicit promotion gate after CI approval.
